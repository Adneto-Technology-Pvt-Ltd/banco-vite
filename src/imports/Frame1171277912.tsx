  ...
  return (
    <div className="bg-[#444444] relative w-full min-h-[60px]">
      <div className="flex flex-col sm:flex-row items-center relative w-full h-full">
        <div className="box-border content-stretch flex flex-col sm:flex-row font-['Lato:Regular',_sans-serif] items-center justify-between leading-[0] not-italic px-4 sm:px-[60px] py-3.5 relative w-full text-[#e2e2e2] text-[12px] sm:text-[14px] text-center sm:text-left tracking-[0.24px] gap-2 sm:gap-0">
          
          {/* Mobile: Stack vertically, Desktop: Side by side */}
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-0">
            <Frame1171277912Helper>
              <span className="inline sm:hidden">© 2025 Axis Bank</span>
              <span className="hidden sm:inline">Copyright © 2025 Axis Bank  |  Terms & Conditions  |  Privacy Policy  |  Contact Us.</span>
            </Frame1171277912Helper>
          </div>
